  ...
  <div class="restaurant-list-page">
    <div class="container">
      ...
      <div class="filter-section">
        ...
        <div class="filter-item">
          <span class="filter-label">人均：</span>
          <el-radio-group v-model="filters.priceRange" @change="handleFilterChange">
            ...
            <el-radio-button label="200">200元以上</el-radio-button>
          </el-radio-group>
        </div>
      </div>
      ...
      <div v-loading="loading" class="restaurant-list">
        ...
        >
          <div class="card-cover">
            ...
            <div class="card-tags">
              <el-tag v-for="tag in getTags(restaurant.tags)" :key="tag" size="small">
                {{ tag }}
              </el-tag>
            </div>
          </div>
          ...
          <div class="card-body">
            ...
            <div class="card-footer">
              <div class="price-info">
                <span class="avg-price">¥{{ restaurant.avgPrice }}</span>
        ...
        <!-- 空状态 -->
        <el-empty v-if="restaurantList.length === 0 && !loading" description="暂无餐厅" />
        ...
        <div v-if="total > 0" class="pagination">
          <el-pagination
            ...
            @current-change="loadRestaurantList"
          />
        </div>
      </div>
    </div>
...
async function loadRestaurantList() {
  ...
  try {
    ...
    restaurantList.value = result.list
    total.value = result.pagination.total
  } catch (error: any) {
    console.error('加载餐厅列表失败:', error)
    ElMessage.error(error.message || '加载餐厅列表失败')
  } finally {
    loading.value = false
  }
}
